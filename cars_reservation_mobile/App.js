  ...
  return (
    <NavigationContainer>
      <Stack.Navigator initialRouteName="CarBook">
        ...
        <Stack.Screen name="Nouveau Utilisateur" component={AddUserScreen} />
        <Stack.Screen
          name="Mes Voitures"
        ...
        <Stack.Screen name="Mes Services" component={AgencyServicesScreen} />
        {/* <Stack.Screen name="Historique" component={CarHistoryScreen} /> */}
        <Stack.Screen name="Historique" component={AgencyHistoryScreen} />
      </Stack.Navigator>
    </NavigationContainer>
  );
};
