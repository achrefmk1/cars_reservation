...
const AgencyHistoryScreen = () => {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Agence : CleanCar</Text>
      ...
      {appointments.length < 0 ? (
        ...
        <View>
          <View style={styles.customCard}>
            <Text style={styles.appointmentInfo}>Audi A3</Text>
            <Text style={styles.appointmentInfo}>Lavage</Text>
            <Text style={styles.appointmentInfo}>Date : 12-07-2023 11:00</Text>
          </View>
          <View style={styles.customCard}>
            <Text style={styles.appointmentInfo}>BMW M5</Text>
            <Text style={styles.appointmentInfo}>Lavage</Text>
            <Text style={styles.appointmentInfo}>Date : 12-07-2023 10:00</Text>
          </View>
          <View style={styles.customCard}>
            <Text style={styles.appointmentInfo}>Peageot 208</Text>
            <Text style={styles.appointmentInfo}>Lavage</Text>
            <Text style={styles.appointmentInfo}>Date : 12-07-2023 10:00</Text>
          </View>
          <View style={styles.customCard}>
            <Text style={styles.appointmentInfo}>Peageot 2008</Text>
            <Text style={styles.appointmentInfo}>Lavage</Text>
            <Text style={styles.appointmentInfo}>Date : 12-07-2023 10:00</Text>
          </View>
          <View style={styles.customCard}>
          ...
          <View style={styles.customCard}>
            <Text style={styles.appointmentInfo}>Mercedes E63s</Text>
            <Text style={styles.appointmentInfo}>Lavage</Text>
...
export default AgencyHistoryScreen;
